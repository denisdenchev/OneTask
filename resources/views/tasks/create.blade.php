...
<div class="createTask">
    ...
    <div class="createTaskForm">
        ...
        <form action="{{ route('tasks.store') }}" method="POST">
            ...
            <x-textarea-label-wrapper labelValue="Task Details" textAreaName="taskDetails" textAreaValue="{{ old('taskDetails') ?? '' }}" textAreaPlaceholder="I will take my dog to the vets on Wednesday" cols="40" rows="5"></x-textarea-label-wrapper>
            @if ($errors->any())
